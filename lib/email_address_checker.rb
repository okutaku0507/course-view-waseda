...
module EmailAddressChecker
  ...
  def well_formed_as_domain_part(str)
    ...
    # return unless str.include?("akane.waseda.jp") || str.include?("asagi.waseda.jp") || str.include?("fuji.waseda.jp") || str.include?("moegi.waseda.jp") || str.include?("ruri.waseda.jp") || str.include?("toki.waseda.jp")
     names = str.split(/\./)
